...
JNICALL
Java_com_example_ndkdemo_BitmapOps_rotateBitmap(JNIEnv *env, jobject thiz, jobject bitmap) {
...
JNICALL
Java_com_example_ndkdemo_BitmapOps_convertBitmap(JNIEnv *env, jobject thiz, jobject bitmap) {
    LOGD("convert bitmap");
    AndroidBitmapInfo bitmapInfo;
    int ret;
    if ((ret = AndroidBitmap_getInfo(env, bitmap, &bitmapInfo)) < 0) {
...
JNICALL
Java_com_example_ndkdemo_BitmapOps_mirrorBitmap(JNIEnv *env, jobject thiz, jobject bitmap) {
    LOGD("mirror bitmap");
    AndroidBitmapInfo bitmapInfo;
    int ret;
    if ((ret = AndroidBitmap_getInfo(env, bitmap, &bitmapInfo)) < 0) {
