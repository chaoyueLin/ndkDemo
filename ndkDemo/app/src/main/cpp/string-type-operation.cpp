...
JNICALL
Java_com_example_ndkdemo_StringTypeOps_getAndReleaseString(JNIEnv *env, jobject thiz,
                                                           jstring str_) {
...
JNICALL
Java_com_example_ndkdemo_StringTypeOps_getHalfString(JNIEnv *env, jobject thiz, jstring str_) {
    const char *str = env->GetStringUTFChars(str_, 0);
...
JNICALL
Java_com_example_ndkdemo_StringTypeOps_reverseString(JNIEnv *env, jobject thiz, jstring str_) {
